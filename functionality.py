import os
import torch
from modelAPI import se_extractor
from modelAPI.api import BaseSpeakerTTS, ToneColorConverter
...
def create_audio(file_name, text):
    ...
    reference_speaker = f'resources/{file_name}' # This is the voice you want to clone
    print("going in\n")
